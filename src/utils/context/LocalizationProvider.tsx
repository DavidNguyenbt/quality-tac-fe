...
const LocalizationProvider: React.FC<{ children: ReactNode }> = ({
  ...
  const [translations, setTranslations] = useState<Localization>(
    (language === "vi" ? viTranslations : enTranslations) as Localization,
  );
  ...
  return (
    <LocalizationContext.Provider
      value={{ language, setLanguage, t: translations, parseParam }}
    >
      {children}
    </LocalizationContext.Provider>
  );
