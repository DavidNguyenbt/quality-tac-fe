...
const DefectImgSup: React.FC<DefectImgSupProps> = ({ datalist }) => {
    ...
    const openLightbox = (item: string, img: string) => {
        setSelectedImg(img);
                    ...
                    {e.ImgSrc && (
                        <Item sx={{ backgroundColor: (theme) => theme.color.background.o1 }}>
                            <LazyImage
                                src={e.ImgSrc}
                                height={200}
                                onClick={() => openLightbox(e.Item, e.ImgSrc)}
                            />
